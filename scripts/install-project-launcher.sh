...
JARVIS_STORY_ORDER_MODE="priority"
...
# JARVIS_CODEX_CAPABILITY_PREFLIGHT=1
# JARVIS_CODEX_CAPABILITY_PREFLIGHT_STRICT=0
# JARVIS_CODEX_ITERATION_TIMEOUT_SECONDS=1800
# JARVIS_COMMIT_MODE=runner
# JARVIS_RUNNER_COMMIT_REQUIRE_CLEAN_START=1
# JARVIS_CLICKUP_SYNC_ON_START=1
# JARVIS_CLICKUP_SYNC_STRICT=0
# JARVIS_CLICKUP_AUTO_DEPLOY_ON_MAIN=0
# JARVIS_CLICKUP_MAIN_COMPLETION_STATUS=testing
...
# JARVIS_PINNED_SCOPE_MUTATION_POLICY=rollback
